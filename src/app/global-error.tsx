          ...
          <main className="relative mx-auto w-full max-w-3xl">
            <section className="rounded-[2rem] border border-red-300 bg-red-50/95 p-6 shadow-[0_16px_48px_rgba(220,38,38,0.15)] sm:p-8">
              ...
              <p className="mt-3 text-base text-red-900/80 sm:text-lg">
                A critical rendering error happened. Please retry the page.
              </p>
              <button
                type="button"
                onClick={reset}
                className="mt-5 inline-flex h-10 items-center justify-center rounded-full border border-red-400 bg-white px-5 text-sm font-bold uppercase tracking-[0.08em] text-red-800 hover:bg-red-100"
              >
                Retry
              </button>
